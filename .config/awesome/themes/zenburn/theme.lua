...
--[[
     Mix of
     Zenburn Awesome WM theme by Adrian C. (anrxc)
     + 
     Copland Awesome WM theme 2.0, github.com/copycat-killer    
     by
     mdube
--]]
...
-- TODO: CLEAN THIS TO USE BETTER NAME
theme.blue   = theme.fg_focus
theme.red    = "#EB8F8F"
theme.green  = "#8FEB8F"
...
--theme.border_bar  = "#474747"
theme.border_bar  = theme.border_focus
...
theme.widget_net_wifi    = theme.confdir .. "/icons/net_wifi.png"
theme.widget_net_wired   = theme.confdir .. "/icons/net_wired.png"
theme.widget_net_vpn     = theme.confdir .. "/icons/net_vpn.png"
